    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.CharField(choices=[('AL', 'All Elements 9s Data Waypoints, Routes, Tracks'), ('WP', 'Waypoints OpenCPN/Element 9s'), ('RT', 'Routes OpenCPN/Element 9s'), ('TR', 'Tracks OpenCPN/Element 9s')], default='AL', max_length=2, null=True)),

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fix_by', models.CharField(choices=[('NF', 'No Fix'), ('GN', 'GPS from Nav device eg Garmin'), ('GP', 'GPS position from Plotter eg RAYMARINE element 9'), ('GD', 'GPS Dongle'), ('GM', 'GPS Mobile phone'), ('NM', 'Near Mark or Known position'), ('DF', 'Decca Fix'), ('RE', 'Running fix estimate')], default='NF', max_length=2, null=True)),
